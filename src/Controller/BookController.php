...
final class BookController extends AbstractController
{
    ...
    public function edit(Request $request, Book $book, SluggerInterface $slugger, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(BookType::class, $book);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('info', "Information modifié avec succès");
    ...
    //     $form = $this->createForm(LoaningType::class, $book);
    //     $form->handleRequest($request);
    //     if ($form->isSubmitted() && $form->isValid()) {
    //         $entityManager->flush();
    ...
    // }
    // return $this->render('loaning/show.html.twig', [
    //     'book' => $book,
